...
class DatasetLoader(object):
    ...
    def load_from_json(self):
        data_files = {
            'train': f'{self.data_root}/{self.dataset_name}_train.json',
            'test': f'{self.data_root}/{self.dataset_name}_test.json',
        }
    ...
    def load_gpt_preds(self, split):
        ...
        with open(f'{self.data_root}/{self.dataset_name}_{split}.json') as f:
            for line in f: 
...
class AnkiFlashcardsLoader(DatasetLoader): 
    def __init__(self): 
